...
export const metadata: Metadata = {
  title: "Customer Support - Your Trusted Partner",
  description:
    "Professional customer support services with quick resolutions, transparent policies, and dedicated assistance.",
  generator: "v0.app",
  icons: {
    icon: [
      {
